...
<section>
<div id="janela">
<legend>Relátorio dos Clientes Ativos</legend>
...
<th class="centro-table">Compras</th>
<th class="centro-table">Editar</th>
</tr>
</thead>
<?php 

$consulta = $pdo->query("SELECT * FROM clientes WHERE cliente_status='ativo' ORDER BY nome ASC ");
$consulta->execute();
...
<td class="centro-table"><a href="?pg=detail-compras&idcliente=<?php echo $linha['idcliente'];?>"><span class="glyphicon glyphicon-th-list"></span></a></td>
